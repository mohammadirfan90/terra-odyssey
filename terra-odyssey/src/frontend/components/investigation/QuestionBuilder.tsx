...
export function QuestionBuilder({
  ...
  const defaultDataset = datasets[0] || null;
  const [selectedDataset, setSelectedDataset] = useState<DatasetMetadata>(defaultDataset);
  ...
  return (
    <div className="flex flex-col space-y-4 max-w-5xl mx-auto w-full">
      ...
      <div className="border border-slate-800/80 rounded-md bg-slate-900/40">
        ...
        {showExpert && (
          <div className="p-3 pt-0 border-t border-slate-800/60 grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
            <div>
