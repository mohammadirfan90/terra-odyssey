/**
 * Mapcn React map components, adapted for Terra Odyssey.
 * Source: https://github.com/AnmolSaini16/mapcn
 * Copyright (c) 2025 Anmoldeep Singh; MIT License. See terra-odyssey/frontend/THIRD_PARTY_LICENSES/MAPCN-MIT.txt.
 */

/* eslint-disable react-hooks/refs, react-hooks/set-state-in-effect -- Mapcn synchronizes React state and current callbacks with MapLibre's imperative lifecycle. */
"use client";
