# Terra Odyssey — Documentation index

| File | Read when | Authority |
|---|---|---|
| `CONTEXT_GUIDE.md` | Every task | Context selection and prompt discipline |
...
small coding task because its size increases distraction and token cost.
