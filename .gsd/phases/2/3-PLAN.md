...
<task type="auto">
  ...
  <files>terra-odyssey/src/analysis/interval_sensitivity.py</files>
  <action>
    Create `terra-odyssey/src/analysis/interval_sensitivity.py` with:
  ...
  <verify>python -c "from src.analysis.interval_sensitivity import compute_interval_sensitivity; print('Interval sensitivity module importable')"</verify>
...
<task type="auto">
  ...
  <files>terra-odyssey/tests/unit/test_interval_sensitivity.py</files>
  <action>
    Create `terra-odyssey/tests/unit/test_interval_sensitivity.py` testing:
